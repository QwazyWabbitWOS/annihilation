...
/* *** TOM *** */
#define EF_IONRIPPER		0x00100000  // light emitter?
#define EF_GREENGIB			0x00200000  // nice trail
#define	EF_BLUEHYPERBLASTER 0x00400000  // blue light emission
#define EF_SPINNINGLIGHTS	0x00800000  // cool! spinning insane mode
#define EF_PLASMA			0x01000000  // semi-transparent, light emitter
#define EF_TRAP				0x02000000  // cool fountain thing

#define EF_TRACKER			0x04000000  // right... (colours)
#define	EF_DOUBLE			0x08000000  // yeallow shell
#define	EF_SPHERETRANS		0x10000000  // transparent
#define EF_TAGTRAIL			0x20000000  // nice trail
#define EF_HALF_DAMAGE		0x40000000  // nice godmode-like shell
#define EF_TRACKERTRAIL		0x80000000  // weird flies/sphere shell thingy/weird colours
/* *** */
...
#define	MAX_STATS				32	// 64 doesn't work - Q2 still only works with 32
