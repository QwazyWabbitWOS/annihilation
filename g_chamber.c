...
void Chamber_Explode(edict_t* particle)
{
	...
	ThrowDebris(particle, DEBRIS3_MODEL, 3.50f, particle->s.origin);
	ThrowDebris(particle, DEBRIS3_MODEL, 2.50f, particle->s.origin);
	ThrowDebris(particle, DEBRIS3_MODEL, 1.50f, particle->s.origin);
	ThrowDebris(particle, DEBRIS3_MODEL, 4.50f, particle->s.origin);
	ThrowDebris(particle, DEBRIS3_MODEL, 3.75f, particle->s.origin);
	ThrowDebris(particle, DEBRIS3_MODEL, 2.30f, particle->s.origin);
	ThrowDebris(particle, DEBRIS3_MODEL, 1.00f, particle->s.origin);
	...
	int preset)   // 1 if preset origin
{
	...
	// Don't want to affect original origin..
