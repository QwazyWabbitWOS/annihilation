...
void LaserDrone_Die(edict_t* LaserDrone, edict_t* inflictor, edict_t* attacker, int damage, vec3_t point)
{
	...
	ThrowDebris(LaserDrone, DEBRIS3_MODEL, 3.75f, LaserDrone->s.origin);
	ThrowDebris(LaserDrone, DEBRIS3_MODEL, 2.50f, LaserDrone->s.origin);
	ThrowDebris(LaserDrone, DEBRIS2_MODEL, 4.60f, LaserDrone->s.origin);
	ThrowDebris(LaserDrone, DEBRIS2_MODEL, 1.50f, LaserDrone->s.origin);
	ThrowDebris(LaserDrone, DEBRIS3_MODEL, 2.30f, LaserDrone->s.origin);
	ThrowDebris(LaserDrone, DEBRIS3_MODEL, 4.50f, LaserDrone->s.origin);
...
qboolean DeActivated(edict_t* LaserDrone)
{
	...
	{
		LaserDrone_Die(LaserDrone, 0, 0, 0, 0);
		return true;
	}
	else
		return false;
